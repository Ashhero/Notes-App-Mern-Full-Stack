...
const TagInput = ({tags,setTags}) => {
  ...
  return (
    <div>
       {/*eslint-disable-next-line react/prop-types */}
       {tags?.length > 0 && (
    <div className='flex items-center gap-2 flex-wrap kt-2'>
        {/*  eslint-disable-next-line react/prop-types */}
        {tags.map((tag, index) => (
      ...
      <div className='flex items-center gap-4 mt-3'>
        ...
        <button className='w-8 h-8 flex items-center justify-center rounded border border-blue-200 hover:bg-blue-700 '
        onClick={()=>{
                addNewTag();
        }}>
